...
public class RechercherProgrammeImmobilierDocumentTest {
	...
	public static JavaArchive createDeployment(){
		...
		@Inject
		ProgrammeImmobilierDocumentCtlInterface programmeImmmobilierDocumentCtl ;
		...
		/**
		 * 
		 * Recherche d'une liste de videos par programme immobilier  et par type document
		 * 
		 *
		@Test
		@UsingDataSet("datasets/produitlogement.yml")
		public  void testRechercherDocumentListParProgrammeImmobilierParVideosList() {
			
			
			//Initialisation des entrants
			
			String idProgrammeImmobilier = "programme01" ;
			
			String typeDocument = "ref.element.typeValeur.video";
			
			//Execution du test
			
			rtnList = programmeImmmobilierDocumentCtl.rechercherDocumentListParProgrammeImmobilierParTypeDocument(idProgrammeImmobilier, typeDocument, true, null, true, locale, msgList);
