...
public class CreerModifierTypeDocumentDemandeReservationLogementTest {
	...
	public static JavaArchive createDeployment(){
		...
		JavaArchive jar = ShrinkWrap.create(JavaArchive.class)
				.addClasses(
						...
						EfiDAO.class,
						CreerModifierCaracteristiqueDemandeReservationLogementCtl.class,
						CreerModifierCaracteristiqueDemandeReservationLogementCtlInterface.class,
	...
	@Inject 
    AssocierTypeDocumentDemandeReservationLogementCtlInterface  associerTypeDocumentDemandeReservationLogementCtl ;
	...
	//Test de creation de deux  caracteristiques demande Reservation logement
	
	
	
	@Test
	@UsingDataSet("datasets/produitlogement.yml")
	public void testAssocierTypeDemandeReservationLogementSansErreur() {
		   ...
		   //Iniatilisation des entrants
			...
			TypeDocumentDemandeReservationLogement typedocumentDemandeReservation1 = new TypeDocumentDemandeReservationLogement();
	   
			Reference typeDocument1 = new Reference();
			typeDocument1.setId("ref.element.demandeAcquisation.typeDocument.CNI");
			
			typedocumentDemandeReservation1.setTypeDocument(typeDocument1);
			...
			typedocumentDemandeReservation1.setProgrammeImmobilier(programmeImmobilier);
			
			
			//Caracteristique Residence permanente
		
			TypeDocumentDemandeReservationLogement typedocumentDemandeReservation2 = new TypeDocumentDemandeReservationLogement();
			
			Reference typeDocument2 = new Reference();
			typeDocument2.setId("ref.element.demandeAcquisation.typeDocument.PP");
			
			typedocumentDemandeReservation2.setTypeDocument(typeDocument2);
			...
			typedocumentDemandeReservation2.setProgrammeImmobilier(programmeImmobilier1);
			
			//Liste de caracteristiques de demande de réservation logement
			
			List<TypeDocumentDemandeReservationLogement> entityList = new ArrayList<TypeDocumentDemandeReservationLogement>();
			
			entityList.add(typedocumentDemandeReservation1);
			entityList.add(typedocumentDemandeReservation2);
		    ...
		    rtnList =  associerTypeDocumentDemandeReservationLogementCtl
		    		          .AssocierTypeDocumentDemandeReservationLogementList(entityList, true, null, true, locale, loggedInUser, msgList);
		    ...
		    assertEquals("ref.element.demandeAcquisation.typeDocument.CNI" , rtnList.get(0).getTypeDocument().getId())  ;
		    
		}
	
	

		//Test d'association d'un type de document demande Reservation logement
	
		@Test
		public void testAssocierTypeDemandeReservationLogementSansErreur1() {
			   ...
			   //Iniatilisation des entrants
				...
				TypeDocumentDemandeReservationLogement typedocumentDemandeReservationLogement1 = new TypeDocumentDemandeReservationLogement();
				
				Reference typedocument1 = new Reference();
				typedocument1.setId("ref.element.demandeAcquisation.typeDocument.CR");
				
				typedocumentDemandeReservationLogement1.setTypeDocument(typedocument1);
				...
				typedocumentDemandeReservationLogement1.setProgrammeImmobilier(programmeImmobilier);
				...
				entityList.add(typedocumentDemandeReservationLogement1);
			    ...
			    assertEquals("Carte de Residence" , rtnList.get(0).getTypeDocument().getDesignation())  ;
			...
			//Associer d'un type document de reservation logement pour un programme immmobilier
			//qui n'existe  pas (code n'existe)
			
			@Test
			public void testAssocierTypeDocumentDemandeReservationLogementSansProgrammeImmobilier() {
				   ...
				   //Iniatilisation des entrants
					...
					Reference typeDocument1 = new Reference();
					typeDocument1.setId("ref.element.typeValeur.string");
			...
			//Association d'un  type de document de demande de reservation logement dont le type de document n'est pas défini
			
			@Test
			public void testAssocierTypeDocumentDemandeReservationLogementSansType() {
				
				
				
				   //Iniatilisation des entrants
				
					//Type de document Fonction
					...
					//typedocumentDemandeReservationLogement1.setType(type1);
