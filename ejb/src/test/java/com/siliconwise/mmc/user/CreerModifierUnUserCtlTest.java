...
import com.siliconwise.mmc.organisation.promoteur.PromoteurCtl;
import com.siliconwise.mmc.organisation.promoteur.PromoteurCtlInterface;
...
public class CreerModifierUnUserCtlTest {
	...
	@Inject
	CreerModifierUnCompteUserCtlInterface creerModifierUnCompteUserCtl ;
	
	private static transient Logger logger = LoggerFactory.getLogger(CreerModifierUnUserCtlTest.class) ;
	
	List<NonLocalizedStatusMessage> msgList = new ArrayList<NonLocalizedStatusMessage>() ;
	Locale locale;
	
	
	//Test de cration d'un compte user sans aucune erreur
	
	@Test
	@UsingDataSet("datasets/produitlogement.yml")
	public void testCreerUserTestSansErreurs() {
		 
		   //Iniatilisation des entrants
		
		   User user = new User();
		   
		   user.setNom("Alzouma Moussa Mahamadou");
		   user.setEmail("moussa.alzouma@siliconwise.biz");
		   user.setTelephone("0759649107");
		   user.setAdresse("Cocody");
		   ...
		   loggedInUser.setEmail("alzoumamoussa40@univmetiers.ci");
		   
		  
		   //Execution  du test et verification des sortants
		    
		   User rtn = creerModifierUnCompteUserCtl.CreerModifierUnCompteUser(user, true, null, true, locale, loggedInUser, msgList);
		   
		   assertEquals("Alzouma Moussa Mahamadou" , rtn.getNom()) ;
		   
		   assertEquals("moussa.alzouma@siliconwise.biz" , rtn.getEmail()) ;
		   
		   
	}
	
	//Test de modification d'un compte user sans aucune erreur
	 
	/*
	@Test
	@UsingDataSet("datasets/produitlogement.yml")
	public void testModifierUserTestSansErreurs() {
		   ...
		   user.setId("user01");
		   user.setNom("Emmanuel Kouevi");
		   user.setEmail("emmanuelkouevi@univmetiers");
		   user.setVersion(0);
		   ...
		   assertEquals("Emmanuel Kouevi" , rtn.getNom()) ;
		   
		   assertEquals("emmanuelkouevi@univmetiers" , rtn.getEmail()) ;
	...
	//Test de creation d'un compte user sans adresse email
	
	@Test
	public void testCreerUserTestSansIdentiteNaturelle() {
		   ...
		   user.setNom("Alzouma Moussa Mahamadou");
		   //user.setEmail("alzoumamoussa18@univmetiers");
		   user.setTelephone("0759649107");
		   user.setAdresse("Cocody");
	...
	//Test de modification d'un compte user sans version
	
	@Test
	public void testModifierUserTestSansVersion() {
