...
public class ConfirmerCompteUserCtlTest {
	...
	@Inject
	CompteUserCtlInterface compteUserCtl;
	
	List<NonLocalizedStatusMessage> msgList = new ArrayList<NonLocalizedStatusMessage>() ;
	Locale locale;
	
	
	//Test de confirmation d'un compte user
	//Avec un code non expiré et rattaché à utilisateur
	
	@Test
	@UsingDataSet("datasets/produitlogement.yml")
	public void testConfirmerCompteUserCtlTest() {
		 
		
		   //Iniatilisation des entrants
		
		   String code = "codeconfirmation01" ;
		   ...
		   Boolean rtn = compteUserCtl.confirmerUnCompteUser(code, true, true, null, true, locale, loggedInUser, msgList);
	...
	//Test de confirmation d'un compte user avec un code de confirmation expiré
	
	@Test
	public void testConfirmerCompteUserCtlTest1() {
		 
		
		   //Iniatilisation des entrants
		
		   String code = "codeconfirmation03" ;
	...
	//Test de confirmation d'un compte user avec un code de confirmation rattaché à un user inexistant
	
	@Test
	public void testConfirmerCompteUserCtlTest2() {
			 
			
		   //Iniatilisation des entrants
			
		   String code = "codeconfirmation02" ;
	    ...
	    //Test de confirmation d'un compte user avec un code de confirmation vide
	
		@Test
		public void testConfirmerCompteUserCtlTest3() {
		...
		//Test de confirmation d'un compte user avec un code de confirmation nul
		
		@Test
		public void testConfirmerCompteUserCtlTest4() {
