...
public class ValiderUnProduitLogementCtlTest2 {
	...
	public static JavaArchive createDeployment(){
		...
		private static transient Logger logger = LoggerFactory.getLogger(ValiderUnProduitLogementCtlTest2.class) ;
	...
	*/	
	...
	/**
	 * Tests portant sur les cas d'exception
	 * 
	 */
		 ...
		 * 
		 * Avec une caracteristique obligatoire non renseignée
		 * 
		 */
		...
		public  void testValiderUnProduitLogementAvecUneCaracteristiqueObligatoireNonRenseignee() {
		 ...
		 * 
		 * Test de validation d'un produit logement
		 * Avec deux caracteristiques obligatoires dont une seule renseignée
		 * 
		 */

/*
		@Test
		public  void testValiderUnProduitLogementAvecDeuxCaracteristiquesObligatoiresDontUneNonRenseignee() {
...
/*
		@Test
		public  void testValiderUnProduitLogementAvecIdEtSansVersion() {
			...
			assertEquals(null, rtn);
				 ...
				 * 
				 * Test de validation d'un produit logement 
				 * Sans le code dudit produit logement
				 * 
				 */
/*
				@Test
				public  void testValiderUnProduitLogementSansCodeProduitLogement() {
			...
			*/
				/**
				 * 
				 * Test de validation d'un produit logement sans un programme immobilier
				 * 
				 * Le programme immobilier auqel est rattaché le produit logement n'est pas défini
				 * 
				 */
/*
				@Test
				public  void testValiderUnProduitLogementSansProgrammeImmobilier() {
...
/*
				@Test
				public  void testValiderUnProduitLogementSansCaracteristique() {
...
*/
				 ...
				 * Test de validation d'un produit logement
				 * 
				 * Avec la propriété estValide à null 
				 * 
				 */

/*
				@Test
				public  void testValiderUnProduitLogementAvecLaProprieteEstValideNull() {
				...
				*/
				 ...
				 * Test de validation d'un produit logement
				 * 
				 * Avec la propriété estValide à false 
				 * 
				 */

/*
				@Test
				public  void testValiderUnProduitLogementAvecLaProprieteEstValideAFalse() {
					...
					produitLogement.setDesignation(" Villa Duplex 4 Pièces");
					produitLogement.setVersion(0);
					produitLogement.setEstValide(false);
