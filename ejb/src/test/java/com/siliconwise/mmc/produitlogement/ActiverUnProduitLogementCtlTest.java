...
public class ActiverUnProduitLogementCtlTest {
	 ...
	 */
		...
		/**
		 * 
		 * Activation d'un produit logement validé
		 *
		 */
		...
		public  void testActiverUnProduitLogement() {
		 ...
		 * 
		 * Avec la propriété estActive à null 
		 * 
		 */
		
		/*
		@Test
		public  void testActiverUnProduitLogementAvecProprieteEstActiveANull() {
		 ...
		 * Activation d'un produit logement
		 * 
		 * Avec la propriété estActive à false
		 * 
		 */
		
		/*
		@Test
		public  void testActiverUnProduitLogementAvecProprieteEstActiveAFalse() {
		...
		/**
		 * 
		 * Activation d'un produit logement avec un programme immobilier non validé
		 * 
		 * 
		 */
		...
		/*
		@Test
		public  void testActiverUnProduitLogementAvecUnProgrammeImmobilierNonValide() {
			...
			assertEquals(null, rtn);
				...
				/**
				 * 
				 * Activation d'un produit logement non validé
				 * 
				 */
		
		/*
				@Test
				public  void testActiverUnProduitLogementNonValide() {
				...
				/**
				 * 
				 * Activation d'un produit logement avec Id et Sans Version
				 * 
				 */
				...
				/**
				 * 
				 * Activation  d'un produit logement qui n'est rattaché à
				 * aucun programme immobilier
				 * 
				 */
				/*
				@Test
