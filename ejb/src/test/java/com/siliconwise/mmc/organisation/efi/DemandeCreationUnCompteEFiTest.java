...
public class DemandeCreationUnCompteEFiTest {
	...
	@Inject
	EfiCtlInterface efiCtl   ;
	
	private static transient Logger logger = LoggerFactory.getLogger(DemandeCreationUnCompteEFiTest.class) ;
	...
	public void testDemandeCreationUnCompteEfi() {
		   ...
		   efi.setEmailAdmin("alzoumamoussa18@univmetiers");
		   efi.setPrenomAdmin("Mahamadou");
		   efi.setNomAdmin("Alzouma Moussa");
		   ...
		   EFi demande = efiCtl.demandeCreationUnCompteEFi(efi, true, null, true, locale, loggedInUser, msgList);
		   
		   assertEquals("BAO BANQUE" , demande.getDesignation());
		   assertEquals("BAO BANQUE" , demande.getDescription());
	...
	@Test
	public void testDemandeCreationUnCompteEFiSansEmail() {
		 
		   //Iniatilisation des entrants
		
		   EFi efi = new EFi();
		   
		   efi.setDesignation("BAO BANQUE 01");
		   efi.setDescription("BAO BANQUE 01");
		  // efi.setEmail("alzoumamoussa19@univmetiers.ci");
		   efi.setEmailAdmin("alzoumamoussa18@univmetiers");
		   efi.setPrenomAdmin("Mahamadou");
		   efi.setNomAdmin("Alzouma Moussa");
	...
	@Test
	public void testDemandeCreationUnCompteEFiSansEmailAdmin() {
		   ...
		   efi.setDesignation("BAO BANQUE 02");
		   efi.setDescription("BAO BANQUE 02");
