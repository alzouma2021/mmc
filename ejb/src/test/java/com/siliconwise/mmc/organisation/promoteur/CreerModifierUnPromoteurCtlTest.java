...
public class CreerModifierUnPromoteurCtlTest {
	...
	@Inject
	CreerModifierUnPromoteurCtlInterface creerModifierUnPromoteurCtl ;
	
	private static transient Logger logger = LoggerFactory.getLogger(CreerModifierUnPromoteurCtlTest.class) ;
	...
	public void testCreerPromoteurTestSansErreurs() {
		   ...
		   Promoteur rtn = creerModifierUnPromoteurCtl.creerModifierUnPromoteur(promoteur, true, null, true, locale, loggedInUser, msgList);
		   
		   assertEquals("SiliconWise" , rtn.getDesignation());
		   assertEquals("SiliconWise" , rtn.getDescription());
		   assertEquals("alzoumamoussa23@univmetiers.ci" , rtn.getEmail());
	...
	@Test
	public void testModifierPromoteurTestSansErreurs() {
		   ...
		   promoteur.setDesignation("SiliconWise");
		   promoteur.setDescription("SiliconWise");
		   promoteur.setEmail("alzoumamoussa24@univmetiers.ci");
		   promoteur.setAdresse("Cocody");
		   promoteur.setIdentifiantLegal("Alzouma Moussa Mahamadou1");
		   promoteur.setRaisonSociale("SIWISE");
		   promoteur.setSigle("SIWISE");
		   promoteur.setTel("07-59-64-91-07");
		   promoteur.setVersion(0);
		   ...
		   assertEquals("SiliconWise" , rtn.getDesignation());
		   assertEquals("SiliconWise" , rtn.getDescription());
		   assertEquals("alzoumamoussa24@univmetiers.ci" , rtn.getEmail());
	...
	// Test des cas d'exceptions
	
	@Test
	public void testCreerPromoteurTestSansIdentiteNaturelle() {
		   ...
		   promoteur.setDesignation("SiliconWise");
		   promoteur.setDescription("SiliconWise");
		   promoteur.setEmail("alzoumamoussa25@univmetiers.ci");
		   promoteur.setAdresse("Cocody");
		  // promoteur.setIdentifiantLegal("Alzouma Moussa Mahamadou");
		   promoteur.setRaisonSociale("SIWISE");
		   promoteur.setSigle("SIWISE");
	...
	@Test
	public void testCreerPromoteurTestSansEmail() {
		   ...
		   promoteur.setDesignation("SiliconWise");
		   promoteur.setDescription("SiliconWise");
		// promoteur.setEmail("alzoumamoussa18@univmetiers.ci");
		   promoteur.setAdresse("Cocody");
		   promoteur.setIdentifiantLegal("Alzouma Moussa Mahamadou");
		   promoteur.setRaisonSociale("SIWISE");
		   promoteur.setSigle("SIWISE");
	...
	@Test
	public void testModifierPromoteurTestSansVersion() {
		   ...
		   promoteur.setDesignation("SiliconWise");
		   promoteur.setDescription("SiliconWise");
		   promoteur.setEmail("alzoumamoussa26@univmetiers.ci");
		   promoteur.setAdresse("Cocody");
		   promoteur.setIdentifiantLegal("Alzouma Moussa Mahamadou");
		   promoteur.setRaisonSociale("SIWISE");
		   promoteur.setSigle("SIWISE");
