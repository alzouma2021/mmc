...
public class ConfirmationCreationUnCompteEFiTest {
	...
	private static transient Logger logger = LoggerFactory.getLogger(ConfirmationCreationUnCompteEFiTest.class) ;
	...
	public void testConfirmationCreationUnCompteEfi() {
		 
		   //Iniatilisation des entrants
		
		   String idEfi = "ecobank" ;
		   ...
		   boolean rtn = efiCtl.confirmerCreationUnCompteEfi(idEfi, true, null, true, locale, loggedInUser, msgList);
