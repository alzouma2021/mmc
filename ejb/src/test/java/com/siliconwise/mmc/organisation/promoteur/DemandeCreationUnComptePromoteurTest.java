...
public class DemandeCreationUnComptePromoteurTest {
	...
	@Inject
	PromoteurCtlInterface promoteurCtl  ;
	
	private static transient Logger logger = LoggerFactory.getLogger(DemandeCreationUnComptePromoteurTest.class) ;
	...
	public void testDemandeCreationUnComptePromoteur() {
		   ...
		   promoteur.setDesignation("SiliconWise");
		   promoteur.setDescription("SiliconWise");
		   promoteur.setEmail("alzoumamoussa23@univmetiers.ci");
		   promoteur.setAdresse("Cocody");
		   promoteur.setIdentifiantLegal("Alzouma Moussa Mahamadou");
		   promoteur.setRaisonSociale("SIWISE");
		   promoteur.setSigle("SIWISE");
		   promoteur.setTel("07-59-64-91-07");
		   promoteur.setEmailAdmin("alzoumamoussa18@univmetiers");
		   promoteur.setPrenomAdmin("Mahamadou");
		   promoteur.setNomAdmin("Alzouma Moussa");
		   ...
		   Promoteur demande = promoteurCtl.demandeCreationUnComptePromoteur(promoteur, true, null, true, locale, loggedInUser, msgList);
		   
		   assertEquals("SiliconWise" , demande.getDesignation());
		   assertEquals("SiliconWise" , demande.getDescription());
		   
	}
	
	
	
	//Tests Sur les cas d'exception

	@Test
	@UsingDataSet("datasets/produitlogement.yml")
	public void testDemandeCreationUnComptePromoteurSansEmail() {
		   ...
		   promoteur.setDesignation("SiliconWise 02");
		   promoteur.setDescription("SiliconWise 02");
		  // promoteur.setEmail("alzoumamoussa23@univmetiers.ci");
		   promoteur.setAdresse("Cocody");
		   promoteur.setIdentifiantLegal("Alzouma Moussa Mahamadou 02");
		   promoteur.setRaisonSociale("SIWISE");
		   promoteur.setSigle("SIWISE");
		   promoteur.setTel("07-59-64-91-07");
		   promoteur.setEmailAdmin("alzoumamoussa02@univmetiers");
		   promoteur.setPrenomAdmin("Mahamadou");
		   promoteur.setNomAdmin("Alzouma Moussa");
	...
	@Test
	@UsingDataSet("datasets/produitlogement.yml")
	public void testDemandeCreationUnComptePromoteurSansEmailAdmin() {
		   ...
		   promoteur.setDesignation("SiliconWise03");
		   promoteur.setDescription("SiliconWise03");
		   promoteur.setEmail("alzoumamoussa03@univmetiers.ci");
		   promoteur.setAdresse("Cocody");
		   promoteur.setIdentifiantLegal("Alzouma Moussa Mahamadou 03");
		   promoteur.setRaisonSociale("SIWISE");
		   promoteur.setSigle("SIWISE");
		   promoteur.setTel("07-59-64-91-07");
		  // promoteur.setEmailAdmin("alzoumamoussa03@univmetiers");
		   promoteur.setPrenomAdmin("Mahamadou");
		   promoteur.setNomAdmin("Alzouma Moussa");
