...
public class ActiverDesactiverUnEfiCtlTest {
	...
	@Inject
	ActiverDesactiverUnEfiCtlInterface activerDesactiverUnEfiCtl ;
	
	private static transient Logger logger = LoggerFactory.getLogger(ActiverDesactiverUnEfiCtlTest.class) ;
	...
	public void testActiverUnEfi() {
		   ...
		   boolean rtn = activerDesactiverUnEfiCtl.activerUnEfi(idEfi, true, null, true, locale, loggedInUser, msgList);
	...
	@Test
	public void testDesactiverUnEfi() {
		   ...
		   boolean rtn = activerDesactiverUnEfiCtl.desactiverUnEfi(idEfi, true, null, true, locale, loggedInUser, msgList);
	...
	@Test
	public void testActiverUnEfiDejaActive() {
		 
		   //Iniatilisation des entrants
		
		   String idEfi = "promoteur02" ;
