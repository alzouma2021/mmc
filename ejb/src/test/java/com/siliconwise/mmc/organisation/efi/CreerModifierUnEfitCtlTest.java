...
public class CreerModifierUnEfitCtlTest {
	...
	@Inject
	CreerModifierUnEfiCtlInterface CreerModifierUnEfiCtl ;
	
	private static transient Logger logger = LoggerFactory.getLogger(CreerModifierUnEfitCtlTest.class) ;
	...
	public void testCreerEFiTestSansErreurs() {
		 
		   //Iniatilisation des entrants
		
		   EFi efi = new EFi();
		   
		   efi.setDesignation("BAO BANQUE");
		   efi.setDescription("BAO BANQUE");
		   efi.setEmail("alzoumamoussa19@univmetiers.ci");
		   ...
		   EFi rtn = CreerModifierUnEfiCtl.creerModifierUnEfi(efi, true, null, true, locale, loggedInUser, msgList);
		   
		   assertEquals("BAO BANQUE" , rtn.getDesignation());
		   assertEquals("BAO BANQUE" , rtn.getDescription());
		   assertEquals("alzoumamoussa19@univmetiers.ci" , rtn.getEmail());
	...
	@Test
	public void testModifierEFiTestSansErreurs() {
		   ...
		   efi.setId("sgbci");
		   efi.setDesignation("BAO BANQUE MODIFIE");
		   efi.setDescription("BAO BANQUE MODIFIE");
		   efi.setEmail("alzoumamoussa20@univmetiers.ci");
		   efi.setVersion(0);
		   ...
		   assertEquals("BAO BANQUE MODIFIE" , rtn.getDesignation());
		   assertEquals("BAO BANQUE MODIFIE" , rtn.getDescription());
		   assertEquals("alzoumamoussa20@univmetiers.ci" , rtn.getEmail());
		   
		   
	}
	
	
	// Tests portant sur les cas d'exceptions
	
	@Test
	public void testCreerEFiTestSansIdentiteNaturelle() {
		   ...
		   efi.setDesignation("BAO BANQUE");
		   efi.setDescription("BAO BANQUE");
		   //efi.setEmail("alzoumamoussa18@univmetiers.ci");
		   ...
		   loggedInUser.setId("user1");
		   loggedInUser.setNom("alzouma");
		   loggedInUser.setEmail("alzoumamoussa21@univmetiers.ci");
	...
	@Test
	public void testModifierEFiTestSansVersion() {
		   ...
		   loggedInUser.setId("user1");
		   loggedInUser.setNom("alzouma");
		   loggedInUser.setEmail("alzoumamoussa22@univmetiers.ci");
