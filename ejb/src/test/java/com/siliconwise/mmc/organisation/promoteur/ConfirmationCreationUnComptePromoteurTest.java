...
public class ConfirmationCreationUnComptePromoteurTest {
	...
	private static transient Logger logger = LoggerFactory.getLogger(ConfirmationCreationUnComptePromoteurTest.class) ;
	...
	public void testConfirmationCreationUnComptePromoteur() {
		  ...
		  boolean rtn = promoteurCtl.confirmerCreationUnComptePromoteur(idPromoteur, true, null, true, locale, loggedInUser, msgList);
