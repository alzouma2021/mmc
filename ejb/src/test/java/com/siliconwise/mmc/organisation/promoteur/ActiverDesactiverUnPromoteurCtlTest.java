...
public class ActiverDesactiverUnPromoteurCtlTest {
	...
	@Inject
	ActiverDesactiverUnPromoteurCtlInterface activerDesactiverUnCompteUserCtl ;
	
	private static transient Logger logger = LoggerFactory.getLogger(ActiverDesactiverUnPromoteurCtlTest.class) ;
	...
	public void testActiverUnPromoteur() {
		 
		   //Iniatilisation des entrants
		
		   String idPromoteur = "promoteur01" ;
		   ...
		   boolean rtn = activerDesactiverUnCompteUserCtl.activerUnPromoteur(idPromoteur, true, null, true, locale, loggedInUser, msgList);
	...
	@Test
	public void testDesactiverUnPromoteur() {
		 
		   //Iniatilisation des entrants
		
		   String idPromoteur = "promoteur02" ;
		   ...
		   boolean rtn = activerDesactiverUnCompteUserCtl.desactiverUnPromoteur(idPromoteur, true, null, true, locale, loggedInUser, msgList);
	...
	@Test
	public void testActiverUnPromoteurDejaActive() {
