...
public class DocumentTest{
	...
	public void retounerDocumentParProduitLogementParTypeDocument() {
		   ...
		   assertEquals(" Ceci est un test pour récuperer une image de consultation d'un produit logement avec ses metadatas et son contenu." , rtn.getContenu() ) ;
	...
	*/
	...
	/**
	 * 
	 * Test de modification des metadats d'un document donné
	 *
	 */
	...
	*/
	...
	/**
	 * 
	 * Test d'ajout d'un document à une entité existante
	 * 
	 * Ajout d'une image à un produit logement 
	 * 
	 * Date: 17/08/2021
	 * 
	 */
	...
	public void appendEntityDocument() {
		 ...
		 document.setDescription("Ajout d'une image à un produit logement ") ;
