 ...
 */
@Entity
@Table(name="valeurcaracteristiqueproduitlogementlong")
@DiscriminatorValue("long")
public class ValeurCaracteristiqueProduitLogementLong extends CaracteristiqueProduitLogement implements Serializable,IEntityMsgVarMap {
	...
	public ValeurCaracteristiqueProduitLogementLong() {
		super();
	}
...
public static ValeurCaracteristiqueProduitLogementLong from(CaracteristiqueProduitLogement valeur) {
		...
		ValeurCaracteristiqueProduitLogementLong rtn = new ValeurCaracteristiqueProduitLogementLong();
...
public static CaracteristiqueProduitLogement to(ValeurCaracteristiqueProduitLogementLong entity) {
