...
@Stateless
public class ValeurCaracteristiqueProduitLogementDoubleDAO implements ValeurCaracteristiqueProduitLogementDoubleDAOInterface , Serializable{
	...
	@Override
	public boolean valider(ValeurCaracteristiqueProduitLogementDouble entity, 
	...
	@Override
	public ValeurCaracteristiqueProduitLogementDouble validerEtEnregistrer(
			ValeurCaracteristiqueProduitLogementDouble entity, boolean mustUpdateExistingNew, String namedGraph,
		...
		ValeurCaracteristiqueProduitLogementDouble rtn = EntityUtil.persistOrMerge(
				entityManager, ValeurCaracteristiqueProduitLogementDouble.class, entity, 
