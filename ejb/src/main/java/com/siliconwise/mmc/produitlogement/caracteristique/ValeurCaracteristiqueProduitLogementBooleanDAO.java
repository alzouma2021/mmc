...
@Stateless
public class ValeurCaracteristiqueProduitLogementBooleanDAO 
										implements Serializable, 
										ValeurCaracteristiqueProduitLogementBooleanDAOInterface{
	...
	@Override
	public boolean valider(ValeurCaracteristiqueProduitLogementBoolean entity, boolean mustUpdateExistingNew,
	...
	@Override
	public ValeurCaracteristiqueProduitLogementBoolean validerEtEnregistrer(
			ValeurCaracteristiqueProduitLogementBoolean entity, boolean mustUpdateExistingNew, String namedGraph,
		    ...
		    //Locale langue = SessionUtil.getLocale(currentSession) ;
				...
				ValeurCaracteristiqueProduitLogementBoolean rtn = EntityUtil.persistOrMerge(
						entityManager, ValeurCaracteristiqueProduitLogementBoolean.class, entity, 
