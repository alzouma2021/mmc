...
public class ProduitLogementDocumentRest implements Serializable {
	 ...
	 * @return une image de consultation d'un produit logement donné
	 */
	@GET
	...
	@ApiResponse(
			responseCode = "204",
			description = "Aucune image de consultation trouvée"
	        )
	@ApiResponse(
			responseCode = "200",
			description = "image de consultation trouvée",
			content = @Content(
...
/************************************************Suppression d'un document appartenat à un produit logement ************************************/
