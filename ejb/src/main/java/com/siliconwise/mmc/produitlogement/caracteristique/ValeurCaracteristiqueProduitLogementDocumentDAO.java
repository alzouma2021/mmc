...
@Stateless
public class ValeurCaracteristiqueProduitLogementDocumentDAO 
										implements Serializable , ValeurCaracteristiqueProduitLogementDocumentDAOInterface{
	...
	@Override
	public boolean valider(ValeurCaracteristiqueProduitLogementDocument entity, 
				...
				try {
					...
					EntityUtil<ValeurCaracteristiqueProduitLogementDocument> entityUtil = new EntityUtil<ValeurCaracteristiqueProduitLogementDocument>(ValeurCaracteristiqueProduitLogementDocument.class) ;
				...
				Set<ConstraintViolation<ValeurCaracteristiqueProduitLogementDocument>> constraintViolationList = validator.validate(entity) ;
				
				for ( ConstraintViolation<ValeurCaracteristiqueProduitLogementDocument> violation : constraintViolationList) {
	...
	@Override
	public ValeurCaracteristiqueProduitLogementDocument validerEtEnregistrer(
							ValeurCaracteristiqueProduitLogementDocument entity, 
							boolean mustUpdateExistingNew, String namedGraph,
		...
		ValeurCaracteristiqueProduitLogementDocument rtn = EntityUtil.persistOrMerge(
				entityManager, ValeurCaracteristiqueProduitLogementDocument.class, entity, 
