...
@Stateless
public class ValeurCaracteristiqueProduitLogementReferenceDAO 
													implements Serializable , ValeurCaracteristiqueProduitLogementReferenceDAOInterface {
	...
	@Override
	public boolean valider(ValeurCaracteristiqueProduitLogementReference entity, 
		...
		try {
			...
			EntityUtil<ValeurCaracteristiqueProduitLogementReference> entityUtil = new EntityUtil<ValeurCaracteristiqueProduitLogementReference>(ValeurCaracteristiqueProduitLogementReference.class) ;
		...
		Set<ConstraintViolation<ValeurCaracteristiqueProduitLogementReference>> constraintViolationList = validator.validate(entity) ;
		
		for ( ConstraintViolation<ValeurCaracteristiqueProduitLogementReference> violation : constraintViolationList) {
	...
	@Override
	public ValeurCaracteristiqueProduitLogementReference validerEtEnregistrer(
							ValeurCaracteristiqueProduitLogementReference entity, 
							boolean mustUpdateExistingNew, String namedGraph,
		...
		ValeurCaracteristiqueProduitLogementReference rtn = EntityUtil.persistOrMerge(
				entityManager, ValeurCaracteristiqueProduitLogementReference.class, entity, 
