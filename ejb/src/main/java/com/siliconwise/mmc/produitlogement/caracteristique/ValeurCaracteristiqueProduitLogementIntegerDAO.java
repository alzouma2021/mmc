...
@Stateless
public class ValeurCaracteristiqueProduitLogementIntegerDAO implements Serializable ,ValeurCaracteristiqueProduitLogementIntegerDAOInterface {
	...
	@Override
	public ValeurCaracteristiqueProduitLogementInteger validerEtEnregistrer(ValeurCaracteristiqueProduitLogementInteger entity,
		...
		ValeurCaracteristiqueProduitLogementInteger rtn = EntityUtil.persistOrMerge(
				entityManager, ValeurCaracteristiqueProduitLogementInteger.class, entity, 
