...
@Stateless
public class ValeurCaracteristiqueProduitLogementDateTimeDAO implements Serializable , ValeurCaracteristiqueProduitLogementDateTimeDAOInterface{
	...
	@Override
	public boolean valider(ValeurCaracteristiqueProduitLogementDateTime entity, boolean mustUpdateExistingNew,
	...
	@Override
	public ValeurCaracteristiqueProduitLogementDateTime validerEtEnregistrer(
								ValeurCaracteristiqueProduitLogementDateTime entity, 
		...
		ValeurCaracteristiqueProduitLogementDateTime rtn = EntityUtil.persistOrMerge(
				entityManager, ValeurCaracteristiqueProduitLogementDateTime.class, entity, 
