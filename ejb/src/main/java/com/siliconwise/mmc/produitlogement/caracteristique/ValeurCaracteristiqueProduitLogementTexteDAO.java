...
@Stateless
public class ValeurCaracteristiqueProduitLogementTexteDAO implements Serializable , ValeurCaracteristiqueProduitLogementTexteDAOInterface{
	...
	@Override
	public boolean valider(ValeurCaracteristiqueProduitLogementTexte entity, 
	...
	@Override
	public ValeurCaracteristiqueProduitLogementTexte validerEtEnregistrer(
								ValeurCaracteristiqueProduitLogementTexte entity, 
								boolean mustUpdateExistingNew, String namedGraph,
		...
		ValeurCaracteristiqueProduitLogementTexte rtn = EntityUtil.persistOrMerge(
				entityManager, ValeurCaracteristiqueProduitLogementTexte.class, entity, 
