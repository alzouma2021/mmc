...
@Stateless
public class ValeurCaracteristiqueProduitLogementStringDAO implements ValeurCaracteristiqueProduitLogementStringDAOInterface , Serializable {
	...
	@Override
	public boolean valider(ValeurCaracteristiqueProduitLogementString entity, boolean mustUpdateExistingNew,
	...
	@Override
	public ValeurCaracteristiqueProduitLogementString validerEtEnregistrer(
			ValeurCaracteristiqueProduitLogementString entity, boolean mustUpdateExistingNew, String namedGraph,
		...
		ValeurCaracteristiqueProduitLogementString rtn = EntityUtil.persistOrMerge(
				entityManager, ValeurCaracteristiqueProduitLogementString.class, entity, 
