...
@Stateless
public class ValeurCaracteristiqueProduitLogementLongDAO implements Serializable , ValeurCaracteristiqueProduitLogementLongDAOInterface {
	...
	@Override
	public boolean valider(ValeurCaracteristiqueProduitLogementLong entity, boolean mustUpdateExistingNew,
	...
	@Override
	public ValeurCaracteristiqueProduitLogementLong validerEtEnregistrer(
									ValeurCaracteristiqueProduitLogementLong entity, 
		...
		ValeurCaracteristiqueProduitLogementLong rtn = EntityUtil.persistOrMerge(
				entityManager, ValeurCaracteristiqueProduitLogementLong.class, entity, 
