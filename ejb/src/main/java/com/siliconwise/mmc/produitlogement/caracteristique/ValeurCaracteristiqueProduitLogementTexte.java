 ...
 */
@Entity
@Table(name="valeurcaracteristiqueproduitlogementtexte")
@DiscriminatorValue("texte")
public class ValeurCaracteristiqueProduitLogementTexte extends CaracteristiqueProduitLogement implements Serializable , IEntityMsgVarMap{
	...
	public ValeurCaracteristiqueProduitLogementTexte() {
		super();
	}
	...
	public static ValeurCaracteristiqueProduitLogementTexte from(CaracteristiqueProduitLogement valeur) {
				...
				ValeurCaracteristiqueProduitLogementTexte rtn = new ValeurCaracteristiqueProduitLogementTexte();
...
public static CaracteristiqueProduitLogement to(ValeurCaracteristiqueProduitLogementTexte entity) {
