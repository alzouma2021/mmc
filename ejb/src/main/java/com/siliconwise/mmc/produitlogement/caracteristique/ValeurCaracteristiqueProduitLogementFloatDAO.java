 ...
 */
@Stateless
public class ValeurCaracteristiqueProduitLogementFloatDAO implements Serializable, 
															ValeurCaracteristiqueProduitLogementFloatDAOInterface{
	...
	@Override
	public boolean valider(ValeurCaracteristiqueProduitLogementFloat entity, 
	...
	@Override
	public ValeurCaracteristiqueProduitLogementFloat validerEtEnregistrer(
			                   ValeurCaracteristiqueProduitLogementFloat entity, 
		...
		ValeurCaracteristiqueProduitLogementFloat rtn = EntityUtil.persistOrMerge(
				entityManager, ValeurCaracteristiqueProduitLogementFloat.class, entity, 
