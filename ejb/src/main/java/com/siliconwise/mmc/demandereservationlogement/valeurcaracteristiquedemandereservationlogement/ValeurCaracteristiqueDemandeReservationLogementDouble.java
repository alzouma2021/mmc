 ...
 */
@Entity
@Table(name="valeurcaracteristiquedemandereservationlogementdouble")
@DiscriminatorValue("double")
public class ValeurCaracteristiqueDemandeReservationLogementDouble extends ValeurCaracteristiqueDemandeReservationLogement implements Serializable,IEntityMsgVarMap{
	...
	public ValeurCaracteristiqueDemandeReservationLogementDouble() {
		super();
	}
	...
	public static ValeurCaracteristiqueDemandeReservationLogementDouble from(ValeurCaracteristiqueDemandeReservationLogement valeur) {
			...
			ValeurCaracteristiqueDemandeReservationLogementDouble rtn = new ValeurCaracteristiqueDemandeReservationLogementDouble();
...
public static ValeurCaracteristiqueDemandeReservationLogement to(ValeurCaracteristiqueDemandeReservationLogementDouble entity) {
