...
@Stateless
public class ValeurCaracteristiqueDemandeReservationLogementDoubleDAO implements ValeurCaracteristiqueDemandeReservationLogementDoubleDAOInterface , Serializable{
	...
	@Override
	public boolean valider(ValeurCaracteristiqueDemandeReservationLogementDouble entity, 
	...
	@Override
	public ValeurCaracteristiqueDemandeReservationLogementDouble validerEtEnregistrer(
			ValeurCaracteristiqueDemandeReservationLogementDouble entity, boolean mustUpdateExistingNew, String namedGraph,
		...
		ValeurCaracteristiqueDemandeReservationLogementDouble rtn = EntityUtil.persistOrMerge(
				entityManager, ValeurCaracteristiqueDemandeReservationLogementDouble.class, entity, 
