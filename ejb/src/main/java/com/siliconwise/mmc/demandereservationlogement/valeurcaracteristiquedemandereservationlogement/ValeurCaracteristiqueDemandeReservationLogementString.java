 ...
 */
@Entity
@Table(name="valeurcaracteristiquedemandereservationlogementstring")
@DiscriminatorValue("string")
public class ValeurCaracteristiqueDemandeReservationLogementString extends ValeurCaracteristiqueDemandeReservationLogement implements Serializable , IEntityMsgVarMap{
	...
	public ValeurCaracteristiqueDemandeReservationLogementString() {
		super();
	}
	...
	public static ValeurCaracteristiqueDemandeReservationLogementString from(ValeurCaracteristiqueDemandeReservationLogement valeur) {
				...
				ValeurCaracteristiqueDemandeReservationLogementString rtn = new ValeurCaracteristiqueDemandeReservationLogementString();
...
public static ValeurCaracteristiqueDemandeReservationLogement to(ValeurCaracteristiqueDemandeReservationLogementString entity) {
