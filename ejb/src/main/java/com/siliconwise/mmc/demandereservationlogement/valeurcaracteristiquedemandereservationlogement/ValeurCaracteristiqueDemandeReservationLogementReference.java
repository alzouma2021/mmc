...
@NamedQueries(value={
		@NamedQuery(
				name="valeurCaracteristiqueDemandeReservationLogementReferenceParDesignation",
				query="SELECT vcplReference.id FROM ValeurCaracteristiqueDemandeReservationLogementReference vcplReference  "
					+ "WHERE vcplReference.designation = :designation")
})
@Entity
@Table(name="valeurcaracteristiquedemandereservationlogementreference")
@DiscriminatorValue("reference")
public class ValeurCaracteristiqueDemandeReservationLogementReference 
		...
		public ValeurCaracteristiqueDemandeReservationLogementReference() {
			super();
		}
		...
		public static ValeurCaracteristiqueDemandeReservationLogementReference from(ValeurCaracteristiqueDemandeReservationLogement valeur) {
				...
				ValeurCaracteristiqueDemandeReservationLogementReference rtn = new ValeurCaracteristiqueDemandeReservationLogementReference();
	...
	public static ValeurCaracteristiqueDemandeReservationLogement  to(ValeurCaracteristiqueDemandeReservationLogementReference entity) {
