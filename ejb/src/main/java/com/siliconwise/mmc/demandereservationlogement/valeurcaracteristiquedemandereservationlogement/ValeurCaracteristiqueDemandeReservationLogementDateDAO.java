...
@Stateless
public class ValeurCaracteristiqueDemandeReservationLogementDateDAO implements Serializable , ValeurCaracteristiqueDemandeReservationLogementDateDAOInterface  {
	...
	@Override
	public boolean valider(ValeurCaracteristiqueDemandeReservationLogementDate entity, boolean mustUpdateExistingNew,
	...
	@Override
	public ValeurCaracteristiqueDemandeReservationLogementDate validerEtEnregistrer(
			ValeurCaracteristiqueDemandeReservationLogementDate entity, boolean mustUpdateExistingNew, String namedGraph,
		...
		ValeurCaracteristiqueDemandeReservationLogementDate rtn = EntityUtil.persistOrMerge(
				entityManager, ValeurCaracteristiqueDemandeReservationLogementDate.class, entity, 
