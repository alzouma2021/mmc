...
@Stateless
public class ValeurCaracteristiqueDemandeReservationLogementDateTimeDAO implements Serializable , ValeurCaracteristiqueDemandeReservationLogementDateTimeDAOInterface{
	...
	@Override
	public boolean valider(ValeurCaracteristiqueDemandeReservationLogementDateTime entity, boolean mustUpdateExistingNew,
	...
	@Override
	public ValeurCaracteristiqueDemandeReservationLogementDateTime validerEtEnregistrer(
								ValeurCaracteristiqueDemandeReservationLogementDateTime entity, 
		...
		ValeurCaracteristiqueDemandeReservationLogementDateTime rtn = EntityUtil.persistOrMerge(
				entityManager, ValeurCaracteristiqueDemandeReservationLogementDateTime.class, entity, 
