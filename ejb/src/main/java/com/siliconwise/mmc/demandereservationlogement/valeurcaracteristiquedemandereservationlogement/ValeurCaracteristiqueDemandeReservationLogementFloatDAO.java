 ...
 */
@Stateless
public class ValeurCaracteristiqueDemandeReservationLogementFloatDAO implements Serializable, 
															ValeurCaracteristiqueDemandeReservationLogementFloatDAOInterface{
	...
	@Override
	public boolean valider(ValeurCaracteristiqueDemandeReservationLogementFloat entity, 
	...
	@Override
	public ValeurCaracteristiqueDemandeReservationLogementFloat validerEtEnregistrer(
			                   ValeurCaracteristiqueDemandeReservationLogementFloat entity, 
		...
		ValeurCaracteristiqueDemandeReservationLogementFloat rtn = EntityUtil.persistOrMerge(
				entityManager, ValeurCaracteristiqueDemandeReservationLogementFloat.class, entity, 
