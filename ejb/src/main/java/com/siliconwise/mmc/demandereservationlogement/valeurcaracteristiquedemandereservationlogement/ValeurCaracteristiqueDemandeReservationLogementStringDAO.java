...
@Stateless
public class ValeurCaracteristiqueDemandeReservationLogementStringDAO implements ValeurCaracteristiqueDemandeReservationLogementStringDAOInterface , Serializable {
	...
	@Override
	public boolean valider(ValeurCaracteristiqueDemandeReservationLogementString entity, boolean mustUpdateExistingNew,
	  ...
	  //Validation des contraintes simples portant sur la validation des annotations des propriétés de classe
		...
		Set<ConstraintViolation<ValeurCaracteristiqueDemandeReservationLogement>> constraintViolationList = validator.validate(entity) ;
		
		for ( ConstraintViolation<ValeurCaracteristiqueDemandeReservationLogement> violation : constraintViolationList) {
	...
	@Override
	public ValeurCaracteristiqueDemandeReservationLogementString validerEtEnregistrer(
			ValeurCaracteristiqueDemandeReservationLogementString entity, boolean mustUpdateExistingNew, String namedGraph,
		...
		ValeurCaracteristiqueDemandeReservationLogementString rtn = EntityUtil.persistOrMerge(
				entityManager, ValeurCaracteristiqueDemandeReservationLogementString.class, entity, 
