...
@Stateless
public class ValeurCaracteristiqueDemandeReservationLogementTimeDAO implements Serializable, ValeurCaracteristiqueDemandeReservationLogementTimeDAOInterface{
	...
	@Override
	public boolean valider(ValeurCaracteristiqueDemandeReservationLogementTime entity, boolean mustUpdateExistingNew,
	...
	@Override
	public ValeurCaracteristiqueDemandeReservationLogementTime validerEtEnregistrer(
			ValeurCaracteristiqueDemandeReservationLogementTime entity, boolean mustUpdateExistingNew, String namedGraph,
		...
		ValeurCaracteristiqueDemandeReservationLogementTime rtn = EntityUtil.persistOrMerge(
				entityManager, ValeurCaracteristiqueDemandeReservationLogementTime.class, entity, 
