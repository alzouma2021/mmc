...
@Stateless
public class ValeurCaracteristiqueDemandeReservationLogementIntegerDAO implements Serializable ,ValeurCaracteristiqueDemandeReservationLogementIntegerDAOInterface {
	...
	@Override
	public ValeurCaracteristiqueDemandeReservationLogementInteger validerEtEnregistrer(ValeurCaracteristiqueDemandeReservationLogementInteger entity,
		...
		logger.info("_110 debut persistence ValeurCaracteristiqueProduitLogementInteger"); //TODO Effacer
		ValeurCaracteristiqueDemandeReservationLogementInteger rtn = EntityUtil.persistOrMerge(
				entityManager, ValeurCaracteristiqueDemandeReservationLogementInteger.class, entity, 
