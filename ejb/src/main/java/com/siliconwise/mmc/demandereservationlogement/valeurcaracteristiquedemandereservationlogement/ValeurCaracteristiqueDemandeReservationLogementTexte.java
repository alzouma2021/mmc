 ...
 */
@Entity
@Table(name="valeurcaracteristiquedemandereservationlogementtexte")
@DiscriminatorValue("texte")
public class ValeurCaracteristiqueDemandeReservationLogementTexte extends ValeurCaracteristiqueDemandeReservationLogement implements Serializable , IEntityMsgVarMap{
	...
	public ValeurCaracteristiqueDemandeReservationLogementTexte() {
		super();
	}
	...
	public static ValeurCaracteristiqueDemandeReservationLogementTexte from(ValeurCaracteristiqueDemandeReservationLogement valeur) {
				...
				//Instance de la classe ValeurCaracteristiqueProduitLogementTexte que retourne la methode from
				ValeurCaracteristiqueDemandeReservationLogementTexte rtn = new ValeurCaracteristiqueDemandeReservationLogementTexte();
				
				//Verification de la variable valeurTexte
...
public static ValeurCaracteristiqueDemandeReservationLogement to(ValeurCaracteristiqueDemandeReservationLogementTexte entity) {
