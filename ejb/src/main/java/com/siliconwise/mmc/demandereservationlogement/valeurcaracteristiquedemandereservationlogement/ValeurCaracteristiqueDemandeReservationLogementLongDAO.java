...
@Stateless
public class ValeurCaracteristiqueDemandeReservationLogementLongDAO implements Serializable , ValeurCaracteristiqueDemandeReservationLogementLongDAOInterface {
	...
	@Override
	public boolean valider(ValeurCaracteristiqueDemandeReservationLogementLong entity, boolean mustUpdateExistingNew,
	...
	@Override
	public ValeurCaracteristiqueDemandeReservationLogementLong validerEtEnregistrer(
									ValeurCaracteristiqueDemandeReservationLogementLong entity, 
		...
		ValeurCaracteristiqueDemandeReservationLogementLong rtn = EntityUtil.persistOrMerge(
				entityManager, ValeurCaracteristiqueDemandeReservationLogementLong.class, entity, 
