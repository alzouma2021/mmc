...
@Stateless
public class FinancementComptantDAO implements Serializable,FinancementComptantDAOInterface{
	...
	@Override
	public boolean valider(FinancementComptant entity,
		...
		//Validation des contraintes simples portant sur la validation des annotations des propriétés de classe
				...
				Set<ConstraintViolation<FinancementComptant>> constraintViolationList = validator.validate(entity) ;
				
				for ( ConstraintViolation<FinancementComptant> violation : constraintViolationList) {
	...
	@Override
	public FinancementComptant validerEtEnregistrer(
								FinancementComptant entity,
		    ...
		    //Locale langue = SessionUtil.getLocale(currentSession) ;
				...
				FinancementComptant rtn = EntityUtil.persistOrMerge(
						entityManager, FinancementComptant.class, entity, 
