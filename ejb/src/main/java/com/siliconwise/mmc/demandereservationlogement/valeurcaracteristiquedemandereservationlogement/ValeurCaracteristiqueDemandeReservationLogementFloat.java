 ...
 */
@Entity
@Table(name="valeurcaracteristiquedemandereservationlogementfloat")
@DiscriminatorValue("float")
public class ValeurCaracteristiqueDemandeReservationLogementFloat extends ValeurCaracteristiqueDemandeReservationLogement implements Serializable,IEntityMsgVarMap {
	...
	public ValeurCaracteristiqueDemandeReservationLogementFloat() {
		super();
	}
	...
	public static ValeurCaracteristiqueDemandeReservationLogementFloat from(ValeurCaracteristiqueDemandeReservationLogement valeur) {
			...
			ValeurCaracteristiqueDemandeReservationLogementFloat rtn = new ValeurCaracteristiqueDemandeReservationLogementFloat();
	...
	public static ValeurCaracteristiqueDemandeReservationLogement to(ValeurCaracteristiqueDemandeReservationLogementFloat entity) {
