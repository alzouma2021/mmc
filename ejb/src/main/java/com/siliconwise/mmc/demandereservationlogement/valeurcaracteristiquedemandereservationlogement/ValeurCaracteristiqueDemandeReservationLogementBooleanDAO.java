...
@Stateless
public class ValeurCaracteristiqueDemandeReservationLogementBooleanDAO 
										implements Serializable, 
										ValeurCaracteristiqueDemandeReservationLogementBooleanDAOInterface{
	...
	@Override
	public boolean valider(ValeurCaracteristiqueDemandeReservationLogementBoolean entity, boolean mustUpdateExistingNew,
	...
	public ValeurCaracteristiqueDemandeReservationLogementBoolean validerEtEnregistrer(
			ValeurCaracteristiqueDemandeReservationLogementBoolean entity, boolean mustUpdateExistingNew, String namedGraph,
		    ...
		    //Locale langue = SessionUtil.getLocale(currentSession) ;
				...
				ValeurCaracteristiqueDemandeReservationLogementBoolean rtn = EntityUtil.persistOrMerge(
						entityManager, ValeurCaracteristiqueDemandeReservationLogementBoolean.class, entity, 
