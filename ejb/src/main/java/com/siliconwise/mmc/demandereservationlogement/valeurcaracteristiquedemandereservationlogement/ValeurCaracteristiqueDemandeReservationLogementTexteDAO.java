...
@Stateless
public class ValeurCaracteristiqueDemandeReservationLogementTexteDAO implements Serializable , ValeurCaracteristiqueDemandeReservationLogementTexteDAOInterface{
	...
	@Override
	public boolean valider(ValeurCaracteristiqueDemandeReservationLogementTexte entity, 
	...
	@Override
	public ValeurCaracteristiqueDemandeReservationLogementTexte validerEtEnregistrer(
								ValeurCaracteristiqueDemandeReservationLogementTexte entity, 
								boolean mustUpdateExistingNew, String namedGraph,
		...
		ValeurCaracteristiqueDemandeReservationLogementTexte rtn = EntityUtil.persistOrMerge(
				entityManager, ValeurCaracteristiqueDemandeReservationLogementTexte.class, entity, 
