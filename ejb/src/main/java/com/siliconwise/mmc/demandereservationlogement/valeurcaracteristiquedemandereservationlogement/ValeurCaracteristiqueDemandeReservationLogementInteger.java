 ...
 */
@Entity
@Table(name="valeurcaracteristiquedemandereservationlogementinteger")
@DiscriminatorValue("integer")
public class ValeurCaracteristiqueDemandeReservationLogementInteger extends ValeurCaracteristiqueDemandeReservationLogement
	...
	public ValeurCaracteristiqueDemandeReservationLogementInteger() {
		super();
	}
...
public static ValeurCaracteristiqueDemandeReservationLogementInteger from(ValeurCaracteristiqueDemandeReservationLogement valeur) {
		...
		//Instance de la classe ValeurCaracteristiqueProduitLogementInteger que retourne la methode from
		 ValeurCaracteristiqueDemandeReservationLogementInteger  rtn = new ValeurCaracteristiqueDemandeReservationLogementInteger();
...
public static ValeurCaracteristiqueDemandeReservationLogement to(ValeurCaracteristiqueDemandeReservationLogementInteger entity) {
