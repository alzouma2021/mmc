 ...
 *
 */
public abstract class HistoryEventCallback implements Serializable {
	 ...
	 * @param msgList list of returned messages
	 */
	public abstract  <T extends IEntityStringkey> void onFailure(
	...
	//TODO A implementer
			...
			//		2. incrementer le nimbre d'essai infructueux
